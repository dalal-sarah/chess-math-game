...
public class Med extends JPanel   implements KeyListener , GLEventListener {
    int x=3;
    int y=3;
    int oldx=3;
    int oldy=3;
    ...
    public Med() {
        ...
        column_label.setBounds(640,345,60,60);
        ...
        DrawScene(7,430,100,7000,7000,60,60);
...
//                stage.show();
    ...
    public void homeBtnAction(MouseEvent mouseEvent) {
    }
}
